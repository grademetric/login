                    ...
                    <ul>
                        ...
                        <li>
                            <a href="calculator.php">
                                ...
                                <span class="nav-item">Grade Calculator</span>
                            </a>
                        </li>
                        <li>
                            <a href="https://cityofmalabonuniversity.edu.ph">
                                <i class="fas fa-school"></i>
                                <span class="nav-item">CMU Website</span>
                            </a>
                        </li>
                        <li>
                            <a href="http://124.105.153.226/">
                                <i class="fas fa-graduation-cap"></i>
                                <span class="nav-item">CMU Portal</span>
                            </a>
                            <li>
                            <a href="../login.php">
                                <i class="fas fa-sign-out-alt"></i>
                                <span class="nav-item">Logout<e/span>
                            </a>
                        </li>
